          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, faculty.faculty_id AS stud FROM returns LEFT JOIN faculty ON faculty.id=returns.faculty_id LEFT JOIN files ON files.id=returns.file_id ORDER BY date_return DESC";
