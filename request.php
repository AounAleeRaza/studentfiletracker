                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$row['author']."</td>
                          <td>
                            <button class='btn btn-success btn-sm edit btn-flat' data-name='".$row['fn']."'><i class='fa fa-edit'></i> Edit</button>
                            <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['firstname']."'><i class='fa fa-trash'></i> Delete</button>
                          </td>
                        </tr>
                      ";
                    }
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      $('.fn').val(response.fn);
      $('#name').val(response.facultyname);
      $('#app').val(response.approve);
