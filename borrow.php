            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  ...
                  $sql = "SELECT *, faculty.faculty_id AS fid, borrow.status AS barstat FROM borrow LEFT JOIN faculty ON faculty.id=borrow.faculty_id LEFT JOIN files ON files.id=borrow.book_id ORDER BY date_borrow DESC";
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#datepicker_edit').val(response.duedate);
